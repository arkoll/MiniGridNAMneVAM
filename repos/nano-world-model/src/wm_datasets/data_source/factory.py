...
def create_data_source(
    ...
    **kwargs
    ...
    if dataset_name == "baba":
        return BabaDataSource(
            data_path=data_path,
            n_rollout=n_rollout,
            **kwargs,
        )

    if dataset_name == "xland":
        return XLandDataSource(
            data_path=data_path,
            n_rollout=n_rollout,
            **kwargs,
        )
    ...
    raise ValueError(
        ...
        f"Supported: point_maze, wall, pusht, rope, granular, rt1, csgo, baba, xland"
    )
